...
print(generate_seq(model, tokenizer, max_length-1, 'WCMPLT' , 3)) #ACNCPT
print(generate_seq(model, tokenizer, max_length-1, 'OCRTOFF' , 3)) #OCRTD
print(generate_seq(model, tokenizer, max_length-1, 'OCRTD' , 3)) #OSNTMLON
print(generate_seq(model, tokenizer, max_length-1, 'OSNTMLON' , 3)) #WCMPLT
print(generate_seq(model, tokenizer, max_length-1, 'ACNCPT' , 3)) #WCMPLT
